...
export const Navbar = () => {
  ...
  return (
    <div className="fixed top-4 md:top-8 left-1/2 z-50 -translate-x-1/2 px-4 w-full max-w-[95vw] md:max-w-fit pointer-events-none">
      <motion.nav 
        variants={{
      ...
      >
        <div className="flex w-full md:w-fit h-14 items-center justify-between md:justify-center gap-x-8 rounded-full bg-[#541409] px-6 md:px-7 text-sm font-medium text-stone-200 shadow-xl">
        <Link
          href="/"
      ...
      <div 
        className={`md:hidden flex flex-col items-center w-full bg-[#541409] rounded-2xl md:rounded-3xl mt-2 overflow-hidden transition-all duration-300 ease-in-out font-light tracking-wide shadow-2xl ${
