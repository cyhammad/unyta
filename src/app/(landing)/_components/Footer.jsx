...
export const Footer = () => {
  return (
    <footer className="w-full bg-[#541409] text-white lg:h-[366px] py-12 lg:py-0 flex items-center px-6">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-0 h-full">
          
          {/* LEFT SIDE: LOGO & ABOUT & SOCIALS (50%) */}
          <div className="w-full md:w-1/2 flex flex-col items-start pr-4">
            <div className="flex items-center gap-x-3 mb-6">
              ...
              />
              <span className="font-cormorant text-[26px] md:text-[28px] uppercase tracking-widest font-medium">UNYTA</span>
            </div>
            <p className="font-sans font-light text-stone-200/80 text-[15px] leading-relaxed mb-8 max-w-[320px]">
          ...
          <div className="w-full md:w-1/2 grid grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="flex flex-col items-start">
              <h4 className="font-sans font-medium text-[13px] sm:text-[16px] md:text-[18px] mb-4 sm:mb-6 md:mb-8 text-white">Product</h4>
              <div className="flex flex-col gap-y-3 sm:gap-y-4 font-sans font-light text-stone-200/70 text-[12px] sm:text-[15px]">
            ...
            {/* LEGAL */}
            <div className="flex flex-col items-start">
              <h4 className="font-sans font-medium text-[13px] sm:text-[16px] md:text-[18px] mb-4 sm:mb-6 md:mb-8 text-white">Legal</h4>
              <div className="flex flex-col gap-y-3 sm:gap-y-4 font-sans font-light text-stone-200/70 text-[12px] sm:text-[15px]">
            ...
            {/* SUPPORT */}
            <div className="flex flex-col items-start">
              <h4 className="font-sans font-medium text-[13px] sm:text-[16px] md:text-[18px] mb-4 sm:mb-6 md:mb-8 text-white">Support</h4>
              <div className="flex flex-col gap-y-3 sm:gap-y-4 font-sans font-light text-stone-200/70 text-[12px] sm:text-[15px]">
        ...
        <div className="mt-12 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-sans font-light text-stone-200/50 text-[13px] md:text-[14px]">
