...
export default function Home() {
  return (
    <main className="min-h-screen w-full bg-white font-sans text-stone-900">
      {/* HERO SECTION */}
      <section className="relative flex h-[100svh] min-h-[700px] w-full flex-col items-center bg-[#F1E8E8] pt-24 md:pt-32 overflow-hidden">
      {/* Hero Content */}
      <motion.div 
        initial="hidden"
        animate="visible"
      ...
      {/* Phone Mockups Stage (Spaced Flexbox layout) */}
      <div className="mt-12 md:mt-16 flex w-full max-w-6xl items-end justify-center gap-2 sm:gap-10 lg:gap-40 px-4 pointer-events-none select-none">
        {/* Left Phone */}
        <motion.div
