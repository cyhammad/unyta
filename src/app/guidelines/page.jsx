    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto py-24 px-6 md:px-12 font-sans font-light text-[#22000C]/90 leading-relaxed text-[15px] md:text-[16px]">
        ...
        <div className="space-y-12">
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">Audience Authenticity Checks</h2>
            <p>
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">No Show Policy</h2>
            <p>
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">Rescheduling Policy</h2>
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">Content Delivery Delays</h2>
            <p>
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">Brand Non-Compliance</h2>
            <p>
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">Creator Non-Compliance</h2>
            <p>
          ...
          <div>
            <h2 className="font-cormorant text-[24px] text-[#741717] font-semibold mb-4 leading-tight">Collaborator Conditions</h2>
            <p className="mb-2">
